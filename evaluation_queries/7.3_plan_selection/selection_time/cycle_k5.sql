...
FROM events MATCH_RECOGNIZE (
    ...
    DEFINE
        ...
        E AS E.primary_type = 'T4' AND E.lon BETWEEN D.lon - 0.02 AND D.lon + 0.02 AND E.lat BETWEEN D.lat - 0.02 AND D.lat + 0.02 AND E.lon BETWEEN A.lon - 0.02 AND A.lon + 0.02 AND E.lat BETWEEN A.lat - 0.02 AND A.lat + 0.02,
        Z AS TRUE
)
