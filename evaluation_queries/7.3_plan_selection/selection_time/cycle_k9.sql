...
FROM events MATCH_RECOGNIZE (
    ...
    PATTERN (A Z* B Z* C Z* D Z* E Z* F Z* G Z* H Z* I)
    DEFINE
        ...
        I AS I.primary_type = 'T8' AND I.lon BETWEEN H.lon - 0.02 AND H.lon + 0.02 AND I.lat BETWEEN H.lat - 0.02 AND H.lat + 0.02 AND I.lon BETWEEN A.lon - 0.02 AND A.lon + 0.02 AND I.lat BETWEEN A.lat - 0.02 AND A.lat + 0.02,
        Z AS TRUE
)
