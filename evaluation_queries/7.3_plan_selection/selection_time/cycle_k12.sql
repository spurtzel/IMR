...
FROM events MATCH_RECOGNIZE (
    ...
    DEFINE
        ...
        L AS L.primary_type = 'T11' AND L.lon BETWEEN K.lon - 0.02 AND K.lon + 0.02 AND L.lat BETWEEN K.lat - 0.02 AND K.lat + 0.02 AND L.lon BETWEEN A.lon - 0.02 AND A.lon + 0.02 AND L.lat BETWEEN A.lat - 0.02 AND A.lat + 0.02,
        Z AS TRUE
)
