...
FROM events MATCH_RECOGNIZE (
    ...
    PATTERN (A Z* B Z* C Z* D Z* E Z* F Z* G Z* H Z* I Z* J Z* K)
    DEFINE
        ...
        K AS K.primary_type = 'T10' AND K.lon BETWEEN J.lon - 0.02 AND J.lon + 0.02 AND K.lat BETWEEN J.lat - 0.02 AND J.lat + 0.02 AND K.lon BETWEEN A.lon - 0.02 AND A.lon + 0.02 AND K.lat BETWEEN A.lat - 0.02 AND A.lat + 0.02,
        Z AS TRUE
)
