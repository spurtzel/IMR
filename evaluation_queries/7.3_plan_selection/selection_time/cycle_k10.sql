...
FROM events MATCH_RECOGNIZE (
    ...
    PATTERN (A Z* B Z* C Z* D Z* E Z* F Z* G Z* H Z* I Z* J)
    DEFINE
        ...
        J AS J.primary_type = 'T9' AND J.lon BETWEEN I.lon - 0.02 AND I.lon + 0.02 AND J.lat BETWEEN I.lat - 0.02 AND I.lat + 0.02 AND J.lon BETWEEN A.lon - 0.02 AND A.lon + 0.02 AND J.lat BETWEEN A.lat - 0.02 AND A.lat + 0.02,
        Z AS TRUE
)
