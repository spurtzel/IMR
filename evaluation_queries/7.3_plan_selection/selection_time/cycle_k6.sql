...
FROM events MATCH_RECOGNIZE (
    ...
    DEFINE
        ...
        F AS F.primary_type = 'T5' AND F.lon BETWEEN E.lon - 0.02 AND E.lon + 0.02 AND F.lat BETWEEN E.lat - 0.02 AND E.lat + 0.02 AND F.lon BETWEEN A.lon - 0.02 AND A.lon + 0.02 AND F.lat BETWEEN A.lat - 0.02 AND A.lat + 0.02,
        Z AS TRUE
)
