...
FROM events MATCH_RECOGNIZE (
    ...
    DEFINE
        ...
        V3 AS V3.primary_type = 'T3' AND V3.lon BETWEEN V2.lon - 0.05 AND V2.lon + 0.05 AND V3.lat BETWEEN V2.lat - 0.02 AND V2.lat + 0.02 AND V3.ts BETWEEN V0.ts AND V0.ts+INTERVAL '0.2' SECOND,
        Z AS TRUE
)
